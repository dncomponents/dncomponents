...
public class MdcCheckBoxViewImplSimple implements CheckBoxView {

    @UiField
    public HTMLInputElement root;

    HtmlBinder uiBinder = HtmlBinder.get(MdcCheckBoxViewImplSimple.class, this);

    public MdcCheckBoxViewImplSimple() {
        uiBinder.bind();
    }

    public MdcCheckBoxViewImplSimple(String template) {
        uiBinder.setTemplateContent(template);
        uiBinder.bind();
    }

    public MdcCheckBoxViewImplSimple(HTMLTemplateElement templateElement) {
