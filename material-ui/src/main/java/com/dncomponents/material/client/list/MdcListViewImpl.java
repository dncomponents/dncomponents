 ...
 */
@UiTemplate
public class MdcListViewImpl implements ListView {
    ...
    public MdcListViewImpl() {
    }

    public MdcListViewImpl(HTMLTemplateElement listMain) {
        HtmlBinder uiBinder = HtmlBinder.get(MdcListViewImpl.class, this);
