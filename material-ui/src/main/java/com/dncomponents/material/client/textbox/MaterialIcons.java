...
public enum MaterialIcons implements HasStyle {
    ...
    public static EnumLookUp<MaterialIcons> lookUp = new EnumLookUp<>(MaterialIcons.values());
    private String styleName;

    MaterialIcons() {
        this.styleName = toString();
    }

    MaterialIcons(String styleName) {
