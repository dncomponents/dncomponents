 ...
 * @author nikolasavic
 */
public abstract class MdcBaseTextView implements TextBoxView {
...
//            helperText.innerHTML = errorMessage;
    ...
    public abstract static class MdcBaseTextViewBuilder<C extends MdcBaseTextViewBuilder> {
        ...
        private boolean checkLabel(MdcBaseTextView v) {
