...
public class MdcCheckBoxViewImpl implements CheckBoxView {
    ...
    HtmlBinder uiBinder = HtmlBinder.get(MdcCheckBoxViewImpl.class, this);


    public MdcCheckBoxViewImpl() {
//        init();
    }
//

    public MdcCheckBoxViewImpl(String template) {
        uiBinder.setTemplateContent(template);
        uiBinder.bind();
    }

    public MdcCheckBoxViewImpl(HTMLTemplateElement templateElement) {
