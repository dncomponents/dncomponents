 ...
 * @author nikolasavic
 */
public class ModalDialog<T> extends BaseComponent<T, ModalDialogView> implements HasShowHandlers, HasHideHandlers {
    ...
    public ModalDialog(ModalDialogView view) {
        super(view);
        bind();
    }
    ...
    @Override
    protected ModalDialogView getView() {
    ...
    public interface ModalRenderer<T> extends Renderer<T, ModalDialogViewSlots> {
    }
    ...
    public static class ModalDialogHtmlParser extends AbstractPluginHelper implements ComponentHtmlParser {
        ...
        @Override
        public ModalDialog parse(Element html, Map<String, ?> elements) {
            ModalDialog modalDialog;

            ModalDialogView view = getView(ModalDialog.class, html, elements);
            if (view != null)
                modalDialog = new ModalDialog(view);
            else
